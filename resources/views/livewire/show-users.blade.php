<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-4">
    ...
    <label for="table-search" class="block mb-2 text-3xl font-medium text-gray-900 uppercase">Liste des utilisateurs</label>
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <label for="editing.role_id"
                    class="block mb-2 text-xl font-medium text-gray-900 ">Role</label>
