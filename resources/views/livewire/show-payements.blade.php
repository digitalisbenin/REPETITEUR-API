<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-4">
    <div class="flex items-center justify-between pb-4">
        <divstyle=" color:rgb(38, 205, 29);  padding:auto">
    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="md">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('MOIS') }}" x-ref="editing.mois" wire:model.defer="editing.mois" />
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('DATE') }}" x-ref="editing.date" wire:model.defer="editing.date" />
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('STATUS') }}" x-ref="editing.status" wire:model.defer="editing.status" />
