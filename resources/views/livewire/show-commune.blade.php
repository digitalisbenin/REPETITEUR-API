...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-4">
    ...
    <div class="flex items-center justify-between pb-4">
        ...
        <div class="">
            <label for="table-search" class="block mb-2 text-3xl uppercase font-medium text-gray-900 "> Liste des communes</label>


        </div>
        <div>
            <button wire:click="create" type="button"
                class="inline-flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-2 mb-2  focus:outline-none "><svg
    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="2xl">
        ...
        <x-slot name="content">
            <div class="mt-4">
                <label for="editing.name" class="block mb-2 text-xl font-medium text-gray-900 ">NOM DE LA COMMUNE</label>
