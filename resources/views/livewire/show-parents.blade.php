...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-4">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <span class="text-green-500">{{ $parent->status }}</span>
    @elseif($parent->status === 'Inactif')
        <span class="text-red-500">{{ $parent->status }}</span>
    @else
        {{ $parent->status }}
    @endif
                </td>
    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="2xl">
        ...
        <x-slot name="content">
            ...
            {{--  <div class="mt-4">
                ...
                <select id="editing.parents_id" wire:model.defer="editing.user_id"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option selected>Selectionnez lutilisateur</option>
