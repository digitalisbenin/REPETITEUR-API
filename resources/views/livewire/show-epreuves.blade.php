...
@endif
    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="md">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('EPREUVE') }}" x-ref="editing.epreuve" wire:model.defer="editing.epreuve" />
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('CORRIGE') }}" x-ref="editing.corrige" wire:model.defer="editing.corrige" />
